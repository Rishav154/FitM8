...
function HomePage({ theme, toggleTheme }) {
  return (
    <div className="flex min-h-screen flex-col">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-background via-background/95 to-background/90 flex items-center min-h-screen pt-16">
        ...
        <div className="absolute -top-40 -right-40 h-96 w-96 rounded-full bg-purple-500/20 blur-3xl dark:bg-purple-500/10" />
        <div className="absolute -bottom-40 -left-40 h-96 w-96 rounded-full bg-primary/20 blur-3xl dark:bg-primary/10" />
        <div className="absolute top-1/3 left-1/4 h-64 w-64 rounded-full bg-pink-500/10 blur-3xl dark:bg-pink-500/5" />
        <div className="absolute bottom-1/4 right-1/3 h-72 w-72 rounded-full bg-cyan-500/10 blur-3xl dark:bg-cyan-500/5" />
      </section>
      {/* Features Section */}
      <section id="features" className="relative bg-muted/50 dark:bg-muted/10 py-16 md:py-20 overflow-hidden">
      ...
      <section className="py-16 md:py-20 relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <Card className="overflow-hidden border-none bg-gradient-to-br from-blue-500/20 to-cyan-500/10 dark:from-blue-500/10 dark:to-cyan-500/5 shadow-lg transition-all hover:shadow-xl">
              <CardHeader>
            ...
            <Card className="overflow-hidden border-none bg-gradient-to-br from-purple-500/20 to-pink-500/10 dark:from-purple-500/10 dark:to-pink-500/5 shadow-lg transition-all hover:shadow-xl">
              <CardHeader>
      ...
      <section className="bg-muted/50 dark:bg-muted/10 py-16 md:py-20 relative overflow-hidden">
        <div className="container mx-auto px-4 md:px-6">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            <h2 className="mb-4 text-3xl font-bold tracking-tight sm:text-4xl bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent">
